...
#endif
  radio.enableAutoPower(-59);  //<=== NEW method! Enables auto transmit power control with a targetRSSI of -59dB
  //==============================================================================================================
...
void loop() {
  ...
  if (radio.receiveDone())
  {
    ...
    Blink(LED,3);
    Serial.print(", Transmit Level="); Serial.print(radio._transmitLevel,DEC);
    Serial.print(", ReceivedRSSI="); Serial.print(radio.getAckRSSI(),DEC);
    Serial.println();
  }
